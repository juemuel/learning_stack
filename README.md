...
> 加粗项目名称内容为目录，已存于Git仓库。

## 一、web_common_learning：前端基础

位于**web_common_learning**下

| 名称                    | 类型              | Github 存档                                                  | 技术点与经验                                                 | Status                                                  |
| ----------------------- | ----------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------- |
| **web_common_learning** | 原生HTML、CSS、JS | 1.**imageDemo**：响应式图片<br />2.**toolKitsDemo**：web工具集合（下载、上传、QRCode、随机颜色等）<br />3.**VideoDemo**：响应式视频<br />4.PopDemo：原生弹窗（网络、cookies）<br />5.**js_ts_learning** | 1. **自定义样式库（待整合）**、响应式布局（flex、媒体查询）、CSS动画<br />2. 事件处理：HTML DOM、DOM2、懒加载<br /> | ★★☆<br />[Details](web_common_learning/README.md)<br /> |
|                         |                   |                                                              |                                                              |                                                         |

## 二、web_frameworks_learning：前端框架

位于**web_frameworks_learning**下
...
## 三、**web_build_learning**：前端优化

位于**web_build_learning**下
...
## web_grapth_demo图形、web_components_demo组件库

位于**web_grapth_demo**和**web_components_demo**下
